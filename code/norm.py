...
name=sys.argv[1]
pssm=pssm_g(name,'/home/sunzhe/MTDsites/run/feature/')
hhm=hhm_g(name,'/home/sunzhe/MTDsites/run/feature/')
spd33=spd_g(name,'/home/sunzhe/MTDsites/run/feature/')
...
np.save('/home/sunzhe/MTDsites/run/npdata/'+name+'.npy',f)
